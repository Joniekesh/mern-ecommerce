...
const Order = () => {
	...
	const { isLoading: deliverLoading, success: deliverSuccess } = orderDeliver;
	...
	const deliverHandler = () => {
		dispatch(deliverOrder(currentOrder));
	};
							...
							<Left>
								...
								<LeftCenter>
									...
									<InfoContainer>
										...
										<AddressValue>{currentOrder.paymentMethod}</AddressValue>
									</InfoContainer>
									<InfoContainer>
										<Address>
										...
										{currentOrder.isPaid ? (
											<AddressValue style={{ color: "green" }}>
												Paid on{" "}
												<b>{new Date(currentOrder.paidAt).toDateString()}</b>
											</AddressValue>
										) : (
							...
							<CartSummary>
								...
								<SummaryContainer>
									...
									<SummaryDetails>
										...
										<SummaryPrice>$ {currentOrder.totalPrice}</SummaryPrice>
									</SummaryDetails>
